                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group {{ $errors->has('phonenumber2') ? 'has-error' : ''}}">
                                    ...
                                    <input type="text" class="form-control" name="phonenumber2" id="phonenumber2"  placeholder="phone number2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="number"  name="totalproject" value="0" readonly>
